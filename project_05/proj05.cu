...
int main(int argc, char *argv[])
{
    ...
    // *********************************
    cudaMalloc(&dholeaxs, NUMTRIALS * sizeof(float));
    cudaMalloc(&dholeays, NUMTRIALS * sizeof(float));
    cudaMalloc(&dholears, NUMTRIALS * sizeof(float));

    cudaMalloc(&dholebxs, NUMTRIALS * sizeof(float));
    cudaMalloc(&dholebys, NUMTRIALS * sizeof(float));
    cudaMalloc(&dholebrs, NUMTRIALS * sizeof(float));

    cudaMalloc(&dholecxs, NUMTRIALS * sizeof(float));
    cudaMalloc(&dholecys, NUMTRIALS * sizeof(float));
    cudaMalloc(&dholecrs, NUMTRIALS * sizeof(float));

    cudaMalloc(&dsuccesses, NUMTRIALS * sizeof(int));
    ...
    cudaMemcpy( 
    hsuccesses, dsuccesses, 
    NUMTRIALS * sizeof(int), 
